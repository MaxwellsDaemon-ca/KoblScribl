...
summary: "A routine breaks, and a salandit tries very hard to pretend it didn’t."
wordCount: 7347
status: "published"
published: true
...
:::texting{sender="alexei" colors="king:green, alexei:purple"}

@king[time=6-10 PM]

Hey, Alexei. How are you holding up?

@alexei[time=11-37 PM]
...
And hey, worse comes to worst one of our characters will die and then one of us can respec into a magic caster class. I can't be smiting everything, you know. :grin:
...
:::texting{title="Noll – Potential 6th Member" sender="alexei" colors="alexei:purple, noll:blue, system:slate"}
...
:::texting{sender="alexei" colors="lyte:yellow, alexei:purple"}
...
:::texting{sender="alexei" colors="alexei:purple"}
...
:::texting{sender="alexei" colors="noll:blue"}
...
:::texting{sender="alexei" colors="alexei:purple, noll:blue"}
